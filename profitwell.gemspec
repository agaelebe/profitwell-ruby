...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'A Ruby toolkit for the Profitwell Transactions API v1 '
  spec.description   = 'Add subscriptions to your ProfitWell account and then automatically have accurate and reliable SaaS metrics.'
